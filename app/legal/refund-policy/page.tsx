...
export default function RefundPolicyPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <h1 className="text-3xl font-extrabold text-[var(--ink-950)]">Refund & Cancellation Policy</h1>
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-[var(--ink-700)]">
        <section>
          <h2 className="mb-3 text-lg font-semibold text-[var(--ink-950)]">1. Scope</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-[var(--ink-950)]">2. Consumer Cancellations</h2>
          <div className="space-y-4">
            <div className="rounded-xl border border-[var(--surface-border)] bg-[var(--surface-soft)] p-4">
              <h3 className="font-semibold text-[var(--ink-950)]">Before Provider Accepts</h3>
            ...
            <div className="rounded-xl border border-[var(--surface-border)] bg-[var(--surface-soft)] p-4">
              <h3 className="font-semibold text-[var(--ink-950)]">After Provider Accepts (Before Work Starts)</h3>
              <p className="mt-1 text-[var(--ink-700)]">
            ...
            <div className="rounded-xl border border-[var(--surface-border)] bg-[var(--surface-soft)] p-4">
              <h3 className="font-semibold text-[var(--ink-950)]">During Active Work</h3>
              <p className="mt-1 text-[var(--ink-700)]">
            ...
            <div className="rounded-xl border border-[var(--surface-border)] bg-[var(--surface-soft)] p-4">
              <h3 className="font-semibold text-[var(--ink-950)]">After Work Is Completed</h3>
              <p className="mt-1 text-[var(--ink-700)]">
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-[var(--ink-950)]">3. Provider Cancellations</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-[var(--ink-950)]">4. Service Guarantee</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-[var(--ink-950)]">5. Dispute Resolution</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-lg font-semibold text-[var(--ink-950)]">6. Refund Timeline</h2>
          <p>
