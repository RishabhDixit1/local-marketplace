...
function LandingSkeleton() {
  return (
    <div className="relative min-h-screen bg-[var(--surface-elevated)]">
      ...
      <main className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="mt-8 text-center sm:mt-12">
          ...
          <div className="mx-auto mt-3 h-5 w-80 animate-pulse rounded bg-[var(--surface-soft)]" />
          <div className="mx-auto mt-6 h-14 max-w-2xl animate-pulse rounded-2xl bg-[var(--surface-soft)]" />
        </div>
