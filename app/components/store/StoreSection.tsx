              ...
              <div key={svc.id} className="flex flex-col justify-between gap-3 rounded-xl border border-slate-800 bg-slate-950 p-4">
                <div>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <span className="font-semibold text-indigo-300">{price != null ? formatPrice(price) : "Price on request"}</span>
                ...
                <div className="flex gap-2">
                  {isOwner ? (
                    ...
                    <>
                      <button
                        type="button"
                        disabled={isSvcOffline || price == null}
                        onClick={() => price != null && handleAddToCart(key, "service", svc.id, svc.title || "Service", price, null)}
                      ...
                      >
                        ...
                        {justAdded ? "Added!" : price != null ? "Add to Cart" : "Price on request"}
                      </button>
                      <button
                        type="button"
                        disabled={isSvcOffline || price == null}
                        onClick={() => price != null && handleBuyNow("service", svc.id, svc.title || "Service", price, null)}
                      ...
                      >
                        ...
                        {price != null ? "Hire Now" : "Price on request"}
                      </button>
                    </>
                  )}
                </div>
      ...
      {(tab === "products" || localServices.length === 0) && localProducts.length > 0 && (
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          {localProducts.map((prod) => {
            ...
            const isDisabled = isOffline || outOfStock || price == null;
                  ...
                  {isOwner ? (
                    ...
                    <>
                      <button
                        type="button"
                        disabled={isDisabled}
                        onClick={() => price != null && handleAddToCart(key, "product", prod.id, prod.title || "Product", price, deliveryMethod)}
                      ...
                      <button
                        type="button"
                        disabled={isDisabled}
                        onClick={() => handleBuyNow("product", prod.id, prod.title || "Product", price ?? 0, deliveryMethod)}
