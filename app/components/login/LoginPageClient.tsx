            ...
            {otpStep ? (
              ...
              >
                ...
                <div className="relative flex items-center gap-3 py-1">
                  ...
                  <span className="text-xs font-medium text-[var(--ink-500)]">or</span>
                  <span className="flex-1 border-t border-[var(--surface-border)]" />
                </div>
                ...
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2.5 rounded-xl border border-[var(--surface-border)] bg-white px-4 py-3 text-sm font-semibold text-[var(--ink-700)] transition hover:border-slate-300 hover:bg-[var(--surface-soft)] active:scale-[0.98]"
                >
