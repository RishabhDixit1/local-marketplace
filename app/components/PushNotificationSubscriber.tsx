  ...
  return (
    <>
        ...
        <div className="rounded-xl border border-[var(--surface-border)] bg-[var(--surface-elevated)] p-3">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-semibold text-[var(--ink-950)]">Stay updated</p>
            ...
            <button
              ...
              className="shrink-0 rounded-lg p-1 text-[var(--ink-500)] hover:bg-[var(--surface-soft)] hover:text-[var(--ink-700)]"
              aria-label="Dismiss"
            >
      ...
      <div className="fixed inset-x-0 bottom-[calc(4.5rem+env(safe-area-inset-bottom))] z-[var(--layer-floating-action)] mx-2 lg:hidden">
        <div className="flex items-center gap-2 rounded-xl border border-[var(--surface-border)] bg-[var(--surface-elevated)] px-3 py-2.5 shadow-lg shadow-slate-900/10">
          <p className="min-w-0 flex-1 text-[11px] font-semibold text-[var(--ink-950)]">
