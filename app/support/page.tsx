...
export const metadata: Metadata = buildPageMetadata({
  title: "Help Centre",
  description: "Get help with ServiQ — find answers about accounts, bookings, payments, provider setup, and troubleshooting tips.",
  path: "/support",
});
...
export default function SupportPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-extrabold tracking-tight text-[var(--ink-950)]">Help Centre</h1>
      <p className="mt-2 text-sm text-[var(--ink-500)]">Frequently asked questions about using ServiQ.</p>
