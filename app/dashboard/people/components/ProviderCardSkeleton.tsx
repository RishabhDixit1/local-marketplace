    ...
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
      {Array.from({ length: count }).map((_, index) => (
        <div
          ...
          className="overflow-hidden rounded-[1.45rem] border border-[var(--surface-border)] bg-[var(--surface-elevated)] shadow-sm sm:rounded-[1.7rem]"
        >
          ...
          <div className="px-3 pb-3 sm:px-5 sm:pb-5">
            <div className="-mt-5 flex justify-center sm:-mt-10">
              <div className="h-[72px] w-[72px] animate-pulse rounded-full border-[3px] border-[var(--surface-elevated)] bg-slate-200 sm:h-[96px] sm:w-[96px] sm:border-4" />
            </div>
