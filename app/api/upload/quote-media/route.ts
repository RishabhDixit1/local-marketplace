...
async function postHandler(request: Request) {
  ...
  const rateLimit = await applyRateLimit(authResult.auth.userId, "upload:quote-media", WRITE_ROUTE_CONFIG);
...
export const POST = withErrorHandling(postHandler, "upload:quote-media");
