...
class ChatRepository {
  ...
  Future<List<ChatConversation>> fetchConversations() async {
    try {
      ...
      throw ApiException('Unable to load conversations. Please try again.');
    }
  }
  ...
  Future<List<ChatMessageItem>> fetchMessages(String conversationId) async {
    try {
      ...
      throw ApiException('Unable to load messages. Please try again.');
    }
  }
  ...
  Future<String> ensureConversation(String recipientId) async {
    try {
      ...
      throw ApiException('Unable to open conversation. Please try again.');
    }
  }
