...
FIREBASE_PROJECT_ID="$(read_env_value "FIREBASE_PROJECT_ID")"
FIREBASE_MESSAGING_SENDER_ID="$(read_env_value "FIREBASE_MESSAGING_SENDER_ID")"
FIREBASE_ANDROID_APP_ID="$(read_env_value "FIREBASE_ANDROID_APP_ID")"
FIREBASE_IOS_APP_ID="$(read_env_value "FIREBASE_IOS_APP_ID")"
