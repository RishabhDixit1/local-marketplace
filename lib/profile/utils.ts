...
export const normalizeProfileRecord = (
  ...
  const profile: ProfileRecord = {
    ...
    locality_id: toNullableString(typeof row?.locality_id === "string" ? row.locality_id : ""),
    service_zone_ids: Array.isArray(row?.service_zone_ids) ? row.service_zone_ids : [],
    service_category_ids: Array.isArray(row?.service_category_ids) ? row.service_category_ids : [],
    service_area_radius_km: parseNumber(row?.service_area_radius_km),
